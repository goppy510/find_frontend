...
import { Box, Flex, Divider, Text, Button } from "@/features/components";
import { PostDetail, PostId } from "@/features/post/types/post_types";
import { FaStar, FaStarHalf, FaRegStar, FaTags, FaHeart, FaEye, FaLaptop } from 'react-icons/fa';
...
const postDetail: PostDetail = {
  ...
  category: "技術",
  thumbnailUrl: "https://dummyimage.com/426x240/000/fff",
  price: 300,
  favorites: 20,
  views: 100,
  rating: 5.0,
...
export default function PostCardDetail({ id }: Props) {
  ...
  const ThumbnailComponent = () => {
    return (
      <Box w={{ base: '100%' }} h={{ md: '35vh' }}>
        <Flex justifyContent="center" alignItems="center" h="100%">
          <Box mx="auto">
            <Box as="img" src={postDetail.thumbnailUrl} mb="4" />
          </Box>
        </Flex>
      </Box>
    );
