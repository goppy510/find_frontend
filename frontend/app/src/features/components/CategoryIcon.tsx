...
const categoryIcons: CategoryIcons = {
  ...
  "エクセル・スプレッドシート": { icon: <FaFileExcel style={{ width: 60, height: 60 }} />, bg: "yellow.300" },
  "パワーポイント・スライド": { icon: <FaFilePowerpoint style={{ width: 60, height: 60 }} />, bg: "orange.300" },
  "ワード・ドキュメント": { icon: <FaFileWord style={{ width: 60, height: 60 }} />, bg: "blue.300" },
  "メール": { icon: <FaEnvelope style={{ width: 60, height: 60 }} />, bg: "green.300" },
